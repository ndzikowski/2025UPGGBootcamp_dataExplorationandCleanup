...
dummy
```
<!-- *I do not think the next part is necessary. We can just practice on the transcriptomics dataset. Or, if we want exercises at this point, they can be done on tables/dataframes accessible through tidyverse, reducing the number of downloads required for the lesson.*
...
```{r load data}
library(tidyverse)
mRNA_file <- "https://github.com/ndzikowski/2025UPGGBootcamp_dataExplorationandCleanup/rawData/GSE81932_Dataset01.txt.gz"
mRNA_data <- read_lines(mRNA_file)

periodically_expressed_genes_file <- "https://github.com/ndzikowski/2025UPGGBootcamp_dataExplorationandCleanup/rawData/GSE81932_Dataset02.txt.gz"
periodically_expressed_genes <- read_lines(periodically_expressed_genes_file)

ribi_annotation_file <- "https://github.com/ndzikowski/2025UPGGBootcamp_dataExplorationandCleanup/rawData/ribosome_biogenesis_annotations.txt"

scer_names_estimates_file <- "https://github.com/ndzikowski/2025UPGGBootcamp_dataExplorationandCleanup/rawData/scer-mrna-protein-absolute-estimate.txt"
```
